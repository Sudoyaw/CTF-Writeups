...
### Makanan Popular
![[Attachments/Pasted image 20240902171805.png]]

The downloaded file was an executable with non printable characters:
![[Attachments/Pasted image 20240902172111.png]]
...
![[Attachments/Pasted image 20240902172226.png]]


### Cer Cari
![[Attachments/Pasted image 20240902172324.png]]
...
![[Attachments/Pasted image 20240902172702.png]]
...
![[Attachments/Pasted image 20240902173556.png]]
...
### Tanpa Nama 3
![[Attachments/Pasted image 20240902174433.png]]
...
![[Attachments/Pasted image 20240902174702.png]]

Taking the result to cyberchef gave us the flag eventually:

![[Attachments/Pasted image 20240902174744.png]]

### Syah Sesat
![[Attachments/Pasted image 20240902174935.png]]
...
### Kekacauan Huruf
![[Attachments/Pasted image 20240902175417.png]]
...
## Trivia and Misc 🧩
### Sembunyi
![[Attachments/Pasted image 20240902180455.png]]
...
![[Attachments/Pasted image 20240902180736.png]]

However, highlighting the file revealed something interesting:
![[Attachments/Pasted image 20240902180824.png]]
...
![[Attachments/Pasted image 20240902181357.png]]


## Cordini
![[Attachments/Pasted image 20240902181437.png]]

A free flag challenge where we just had to head on towards the discord, react to a message and get rewarded.

![[Attachments/Pasted image 20240902181545.png]]

![[Attachments/Pasted image 20240902181557.png]]
...
## OSINT 🔍
## Jalan-Jalan Desa
![[Attachments/Pasted image 20240902181936.png]]

Image File:
![[Attachments/Pasted image 20240902182124.png]]
...
![[Attachments/Pasted image 20240902182342.png]]
...
![[Attachments/Pasted image 20240902183342.png]]
...
![[Attachments/Pasted image 20240902183547.png]]
...
![[Attachments/Pasted image 20240902185058.png]]

Flag: `3108{3.15,101.70}`

### Pahlawan Lagenda

![[Attachments/Pasted image 20240902185201.png]]

We were given a text file with filler text in it 

![[Attachments/Pasted image 20240902185337.png]]

Again, we can filter out the flag format for the flag:
![[Attachments/Pasted image 20240902185402.png]]

### Kontras
![[Attachments/Pasted image 20240902185506.png]]
...
![[Attachments/Pasted image 20240902185837.png]]
...
### Pangkalan
![[Attachments/Pasted image 20240902190010.png]]
...
![[Attachments/Pasted image 20240902190249.png]]
...
![[Attachments/Pasted image 20240902194135.png]]

For example, visiting the endpoint with year 1763 gave us the following:

![[Attachments/Pasted image 20240902194401.png]]
...
![[Attachments/Pasted image 20240902194611.png]]
...
![[Attachments/Pasted image 20240902194812.png]]

## Merdeka
![[Attachments/Pasted image 20240902194951.png]]

The url presents us with a site with some of Malaysia's patriotic songs and their lyrics.  

![[Attachments/Pasted image 20240902195223.png]]
...
![[Attachments/Pasted image 20240902195334.png]]
...
![[Attachments/Pasted image 20240902200358.png]]
...
![[Attachments/Pasted image 20240902200603.png]]
...
![[Attachments/Pasted image 20240902202512.png]]

Decoding from cyberchef:

![[Attachments/Pasted image 20240902202648.png]]
...
![[Attachments/Pasted image 20240902203004.png]]


## Kapla Harimau Selatan

![[Attachments/Pasted image 20240902204939.png]]
...
![[Attachments/Pasted image 20240902205911.png]]
...
![[Attachments/Pasted image 20240902210104.png]]
...
![[Attachments/Pasted image 20240902210555.png]]

With our info gathered, I tried to manipulate the request headers as such:

![[Attachments/Pasted image 20240902211018.png]]
...
![[Attachments/Pasted image 20240902211207.png]]

Close enough. Hmm....  I then tried again with the plaintext 'Gangganu' andddd we got the flag!

![[Attachments/Pasted image 20240902211250.png]]


### Hang Tak Tidur Lagi?

![[Attachments/Pasted image 20240902211529.png]]

We were presented with a login form upon visiting the URL:

![[Attachments/Pasted image 20240902211830.png]]
...
![[Attachments/Pasted image 20240902211947.png]]
...
![[Attachments/Pasted image 20240902212347.png]]
...
### Wordle Bahasa Utaqa
![[Attachments/Pasted image 20240902213252.png]]
